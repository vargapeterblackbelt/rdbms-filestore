...
public final class FileEntity {
    ...
    public static FileEntity fillEntity(String filename, String mimeType, String fileId, Timestamp createTime, long size, InputStream data) {
        return new FileEntity(filename, mimeType, fileId, createTime, size, data);
    }
    ...
    private FileEntity(String filename, String mimeType, String fileId, Timestamp createTime, long size, InputStream data) {
